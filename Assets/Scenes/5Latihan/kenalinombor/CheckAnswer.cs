...
public class CheckAnswer : MonoBehaviour
{
    public GameObject lettreOne, lettreTwo, lettreThree, lettreFor, lettreFive, lettreSix, lettreSeven,
                       lettreEight, BoxOne, BoxTwo, BoxThree, BoxFor, BoxFive, BoxSix;
    ...
    public GameObject questionToHide, questionToShow,CrabTrue,CrabFalse;
    ...
    public void Check2()
    {
        ...
        str2 = BoxOne.name + BoxTwo.name + BoxThree.name + BoxFor.name;
        //str = BoxFive.name + BoxFor.name + BoxThree.name + BoxTwo.name + BoxOne.name;
    ...
    void DelayedAction()
    {
        CrabFalse.SetActive(false);
        CrabTrue.SetActive(false);
    }
